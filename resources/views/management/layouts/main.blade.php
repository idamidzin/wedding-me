...
<head>
    ...
    <title>@yield('title') | Wedding Management</title>
...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed text-sm {{ request()->is('mcu*') ? 'sidebar-collapse' : '' }}">
    <div class="wrapper">
        <nav class="main-header navbar navbar-expand navbar-dark navbar-blue navbar-fixed">
            <ul class="navbar-nav">
                <li class="nav-item">
        ...
        @include('management.layouts.particals.sidebar')
        ...
        <footer class="main-footer"><div class="float-right d-none d-sm-inline-block"><b>&copy; IdamTech</b></div></footer>
    </div>
