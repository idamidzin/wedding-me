...
<div class="row">
    <div class="col-6">
        <div class="card card-outline card-blue">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('mgt.gift.store') }}">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="amount" class="form-control" placeholder="Jumlah Hadiah" id="rupiah" required>
                            </div>
                            <div class="form-group">
                                <label>Alamat<strong class="text-danger"></strong></label>
                                <textarea name="address" class="form-control" placeholder="Tuliskan alamat lengkap"></textarea>
                            </div>
