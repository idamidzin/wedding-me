    ...
    <div class="card card-outline card-blue">
        <div class="card-body login-card-body">
            <div class="login-logo">
                <!-- <img src="{{ asset('images/logo.png') }}" alt="Logo Wedding" width="100px"> -->
            </div>
            <p class="login-box-msg">Wedding | Administrator</p>
            @if( session('msg') )
            <?php 
            $msg = session('msg');
            ?>
            ...
            @endif
            <form id="form-login" action="{{ route('login.process') }}" method="post">
                @csrf
